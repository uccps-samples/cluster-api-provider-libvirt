...
// +k8s:conversion-gen=github.com/uccps-samples/cluster-api-provider-libvirt/pkg/apis/libvirtproviderconfig
// +k8s:defaulter-gen=TypeMeta
// +groupName=libvirtproviderconfig.uccp.io
package v1beta1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "libvirtproviderconfig.uccp.io", Version: "v1beta1"}
...
func (codec *LibvirtProviderConfigCodec) DecodeFromProviderSpec(providerConfig machinev1.ProviderSpec, out runtime.Object) error {
	if providerConfig.Value != nil {
		...
		// libvirtprovider apis pivoted under uccp.io api group
