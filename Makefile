...
ORG_PATH    ?= github.com/uccps-samples
REPO_PATH   ?= $(ORG_PATH)/$(PROJECT)
CLUSTER_API ?= github.com/uccps-samples/cluster-api
...
.PHONY: gencode
gencode:
	go install $(GOGCFLAGS) -ldflags '-extldflags "-static"' github.com/uccps-samples/cluster-api-provider-libvirt/vendor/github.com/golang/mock/mockgen
	go generate ./pkg/... ./cmd/...
